    ...
    public function up()
    {
        ...
        if (!Schema::hasTable('voters')) {
            Schema::create('voters', function (Blueprint $table) {
                ...
                $table->char('street_name',100)->nullable();
                ...
                $table->char('precinct_name',60)->nullable();
                $table->char('precinct',60)->nullable();
                $table->char('split',20)->nullable();
                $table->timestamps();
