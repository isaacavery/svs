    ...
    public function up()
    {
        ...
        if (!Schema::hasTable('voters')) {
            Schema::create('voters', function (Blueprint $table) {
                ...
                $table->char('name_suffix',20);
                $table->char('birth_date',60);
                $table->char('confidential',120);
                ...
                $table->integer('house_num')->nullable()->default(null);
                $table->char('house_suffix',60);
                $table->char('pre_direction',60);
                $table->char('street_name',100);
                $table->char('street_type',20);
                $table->char('post_direction',60);
                $table->char('unit_type',20);
                $table->char('unit_num',20);
                $table->char('addr_non_std',255);
                $table->char('city',100);
                $table->char('state',20);
                $table->char('zip_code',20);
                $table->char('zip_plus_four',20);
                $table->char('eff_address_1',255);
                $table->char('eff_address_2',255);
                $table->char('eff_address_3',255);
                $table->char('eff_address_4',255);
                $table->char('eff_city',255);
                $table->char('eff_state',20);
                $table->char('eff_zip_code');
                $table->char('eff_zip_plus_four',20);
                $table->char('absentee_type',20);
