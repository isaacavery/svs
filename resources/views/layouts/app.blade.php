                ...
                <div class="collapse navbar-collapse" id="app-navbar-collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        @else
                            ...
                            Signers added: {{ DB::table('signers')->join('sheets','sheets.id','=','signers.sheet_id')->where('sheets.self_signed',0)->where('signers.user_id',Auth::user()->id)->where('signers.voter_id','!=',0)->whereNotNull('signers.voter_id')->count() }}</li>
                            <li class="dropdown">
